...
class ImagePickerHelper {
  ...
  static Future<void> showImageSourceOptions(BuildContext context, {
            ...
            children: <Widget>[
              ListTile(
                ...
                onTap: () {
                  ...
                  pickImageFromSource(ImageSource.gallery, onImageSelected: onImageSelected);
                },
              ),
              ListTile(
                ...
                onTap: () {
                  Navigator.pop(context);
                  pickImageFromSource(ImageSource.camera, onImageSelected: onImageSelected);
                },
              ),
            ],
          ),
  ...
  static Future<void> pickImageFromSource(ImageSource source, {
    required Function(File) onImageSelected,
  }) async {
    try {
  ...
  static Future<void> pickFromGallery({
    ...
    await pickImageFromSource(ImageSource.gallery, onImageSelected: onImageSelected);
  }
  ...
  static Future<void> pickFromCamera({
    ...
    await pickImageFromSource(ImageSource.camera, onImageSelected: onImageSelected);
  }
